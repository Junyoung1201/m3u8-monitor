...
function setupTest() {
    ...
    store.dispatch(setUrlList([
        { fileName: "영상 파일 이름 영상 파일 이름 영상 파일 이름영상 파일 이름 영상 파일 이름 영상 파일 이름영상 파일 이름 영상 파일 이름 영상 파일 이름영상 파일 이름 영상 파일 이름 영상 파일 이름영상 파일 이름 영상 파일 이름 영상 파일 이름", url: "이건 영상 m3u8 url 텍스트"},
        { fileName: "영상 파일 이름 영상 파일 이름 영상 파일 이름영상 파일 이름 영상 파일 이름 영상 파일 이름영상 파일 이름 영상 파일 이름 영상 파일 이름영상 파일 이름 영상 파일 이름 영상 파일 이름영상 파일 이름 영상 파일 이름 영상 파일 이름", url: "이건 영상 m3u8 url 텍스트2", downloading: true },
        { fileName: "영상 파일 이름 영상 파일 이름 영상 파일 이름영상 파일 이름 영상 파일 이름 영상 파일 이름영상 파일 이름 영상 파일 이름 영상 파일 이름영상 파일 이름 영상 파일 이름 영상 파일 이름영상 파일 이름 영상 파일 이름 영상 파일 이름", url: "이건 영상 m3u8 url 텍스트3"},
        { fileName: "영상 파일 이름 영상 파일 이름 영상 파일 이름영상 파일 이름 영상 파일 이름 영상 파일 이름영상 파일 이름 영상 파일 이름 영상 파일 이름영상 파일 이름 영상 파일 이름 영상 파일 이름영상 파일 이름 영상 파일 이름 영상 파일 이름", url: "이건 영상 m3u8 url 텍스트4", downloading: true },
